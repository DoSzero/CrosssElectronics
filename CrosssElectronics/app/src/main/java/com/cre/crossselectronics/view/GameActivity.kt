...
import com.cre.crossselectronics.adapters.OnSwipeListener
...
class GameActivity : AppCompatActivity() {
    ...
    private var itemsRes = intArrayOf(
        ...
        R.drawable.electronic4,
        R.drawable.electronic5,
        R.drawable.electronic6,
    )
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        for (imageView in itemsVi) {
            imageView.setOnTouchListener(object : OnSwipeListener(this@GameActivity) {
