...
import com.cre.crossselectronics.model.SwipeConst
import com.cre.crossselectronics.view.GameActivity
import kotlin.math.abs


open class OnSwipeListener(gameActivity: GameActivity) : View.OnTouchListener {
    ...
    init {
        gestureDetector = GestureDetector(gameActivity, OnSwipeListener())
    }
